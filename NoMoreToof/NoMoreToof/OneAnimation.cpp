...
OneAnimation::OneAnimation(const std::string& texturePath, int numRows, int numCols, int numFrames, float frameTime)
	: m_numRows(numRows), m_numCols(numCols), m_numFrames(numFrames), m_frameTime(frameTime), m_currentCol(0), m_currentRow(0), m_currentFrame(0), m_currentTimer(0.0f)
{
